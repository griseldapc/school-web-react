...
import '../dist/css/detail_artikel.css';

export default function Detail_artikel() {
    return (
        <section className='detail-artikel' style={{ backgroundImage: "url('../../asset/beranda/Vector 1.png')" }}>
            <div className='detail-content'>
                <img src='../../asset/artikel/berita.png'></img>
                <button className="button-content rounded-pill px-3 py-1">
                    12 Desember 2021
                </button>
                <h1 className="judul-content">Gotong Royong di Sekolah, Bantu Anak Segera Kembali ke Sekolah</h1>
                <p className="penulis-content">Penulis : Shinta A.P</p>
                <p className="deskripsi-content">
