    ...
    return (
      <nav>
        <section className="hero"
          ...
          <div className='gambar d-lg-flex flex-row justify-content-between'>
            <div className="text">
              <h1>Hubungi Kami</h1>
        ...
        <section className="form">
          ...
          <div className="icon d-flex justify-content-between">
            <ul>
            <div className="telepon d-flex align-items-center gap-4 py-3">
              ...
              <div className="email d-flex align-items-center gap-4 py-3">
              ...
              <div className="lokasi d-flex align-items-center gap-4 py-3">
